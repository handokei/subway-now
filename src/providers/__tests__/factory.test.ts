...
jest.mock('../arrival/BffArrivalProvider', () => ({
  BffArrivalProvider: mockBffConstructor,
}));

jest.mock('../arrival/SeoulOpenApiProvider', () => ({
...
describe('providers/arrival/index re-exports', () => {
  it('should export SeoulOpenApiProvider, BffArrivalProvider, MockArrivalProvider', () => {
    const arrivalIndex = require('../arrival/index');
...
describe('providers/index re-exports', () => {
  it('should export createArrivalProvider and provider classes', () => {
    const providersIndex = require('../index');
    expect(providersIndex.createArrivalProvider).toBeDefined();
